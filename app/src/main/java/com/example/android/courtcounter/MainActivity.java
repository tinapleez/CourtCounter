 ...
 * ((TL:DR – You have my permission to use, modify, and share my work as long as you provide attribution to me, the copyright holder. Also, you must keep this license attached to all copies.))
...
public class MainActivity extends AppCompatActivity {
    ...
    /**
     * Declare score variable for Team A
     */
    int scoreTeamA = 0;

    /**
     * Declare score variable for Team B
     */
    int scoreTeamB = 0;
    ...
    /**
     *  Resets the scores for Team A and B to zero
     */
